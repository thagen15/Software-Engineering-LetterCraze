...
public class LevelTemplate extends JFrame {
	 ...
	 */
	public static void LevelTemplate() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LevelTemplate frame = new LevelTemplate();
	...
	private void initComponents() {
		...
		label_5.setIcon(new ImageIcon(ThemeLevelTemplate.class.getResource("/LetterCrazeWindowBuilder/resources/starlevel.png")));
